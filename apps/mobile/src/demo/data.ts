// The demo inbox — a copy of the server's DEMO_THREADS (apps/api/src/demo-data.ts;
// the api app isn't an importable package). Same fictional companies as the
// desktop app's MockProvider, so every surface's demo tells the same story.
