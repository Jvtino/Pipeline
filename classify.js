...
const RESCHEDULE_RE = /\b(?:reschedul(?:e|ing|ed)|find (?:another|a new) time|(?:another|an alternative|a new) time for (?:our|your|the)|conflict (?:has )?c[ao]me up|no longer works for (?:us|me)|does .{0,30} work instead|(?:updated|revised) (?:calendar )?invite|cancel (?:our|your|the|tomorrow'?s) (?:interview|meeting|call))\b/;
