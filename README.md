...
3. Run:
   ```bash
   IMAP_USER="you@gmail.com" IMAP_PASSWORD="the-16-char-app-password" python3 server.py
   ```
...
3. Run:
   ```bash
   IMAP_USER="you@outlook.com" IMAP_PASSWORD="the-app-password" python3 server.py
   ```
